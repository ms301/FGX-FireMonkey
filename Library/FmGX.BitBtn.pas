...
{ TfgCustomBitBtn }
  ...
  TfgxCustomBitBtn = class (TSpeedButton)
  public
...
{ TfgBitBtn }
  ...
  TfgxBitBtn = class (TfgxCustomBitBtn)
  published
    property Kind;
    property GroupName;
    { TfgCustomButton }
...
procedure TfgxCustomBitBtn.ApplyStyle;
var
  T: TFmxObject;
begin
...
constructor TfgxCustomBitBtn.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  FKind := DEFAULT_KIND;
end;

procedure TfgxCustomBitBtn.DoImageLinkChanged(Sender: TObject);
begin
  UpdateGlyph;
end;

procedure TfgxCustomBitBtn.FreeStyle;
begin
  FStyleImage := nil;
  inherited FreeStyle;
end;

function TfgxCustomBitBtn.GetDefaultStyleLookupName: string;
begin
  Result := 'buttonstyle';
end;

function TfgxCustomBitBtn.GetIsMousePressed: Boolean;
begin
  Result := FMousePressed;
end;

function TfgxCustomBitBtn.GetStyleText: TControl;
begin
...
procedure TfgxCustomBitBtn.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  FMousePressed := True;
...
procedure TfgxCustomBitBtn.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
...
procedure TfgxCustomBitBtn.SetKind(const Value: TfgBitBtnKind);
begin
  if FKind <> Value then
  begin
    FKind := Value;
...
procedure TfgxCustomBitBtn.UpdateGlyph;
...
initialization
  RegisterFmxClasses([TfgxCustomBitBtn, TfgxBitBtn]);
end.
