...
uses
  System.Math, System.SysUtils, FMX.Forms, FMX.Platform, FmGX.Helpers, FmGX.Consts,
  FmGX.Asserts, FMX.Types, FMX.Filter.Custom, FMX.Filter, System.UIConsts,
  FMX.Effects;
...
function MakeColor(const ASource: TAlphaColor; AOpacity: Single): TAlphaColor;
begin
  TfgxAssert.InRange(AOpacity, 0, 1);
