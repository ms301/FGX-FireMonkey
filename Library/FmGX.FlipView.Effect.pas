...
unit FmGX.FlipView.Effect;

interface

uses
  FMX.Presentation.Style, FMX.Controls.Presentation, FMX.Filter.Effects, FMX.Ani, FMX.Objects, FMX.Controls.Model,
  FMX.Graphics, FMX.Presentation.Messages, FMX.Controls, FmGX.FlipView.Presentation, FmGX.FlipView.Types, FmGX.FlipView;

type

{ TfgFlipViewEffectPresentation }

  TfgxFlipViewEffectPresentation = class(TfgStyledFlipViewBasePresentation)
  private
  ...
  protected
    { Messages From Model}
    procedure MMEffectOptionsChanged(var AMessage: TDispatchMessage); message TfgxFlipViewMessages.MM_EFFECT_OPTIONS_CHANGED;
  protected
...
uses
  System.Types, System.SysUtils, System.Rtti, FMX.Presentation.Factory, FMX.Types, FmGX.Asserts,
  System.Classes, System.Math;

{ TfgFlipViewEffectPresentation }

procedure TfgxFlipViewEffectPresentation.ApplyStyle;
var
  NewImage: TBitmap;
begin
...
procedure TfgxFlipViewEffectPresentation.FreeStyle;
begin
...
procedure TfgxFlipViewEffectPresentation.HandlerFinishAnimation(Sender: TObject);
begin
  try
...
procedure TfgxFlipViewEffectPresentation.MMEffectOptionsChanged(var AMessage: TDispatchMessage);
begin
  RecreateEffect;
  FTransitionAnimaton.Duration := Model.EffectOptions.Duration;
end;

procedure TfgxFlipViewEffectPresentation.RecreateEffect;
var
  EffectClass: TfgxImageFXEffectClass;
begin
  TfgxAssert.IsNotNil(Model);
  TfgxAssert.IsNotNil(Model.EffectOptions);
  TfgxAssert.IsNotNil(Model.EffectOptions.TransitionEffectClass);
...
procedure TfgxFlipViewEffectPresentation.ShowNextImage(const ANewItemIndex: Integer; const ADirection: TfgxDirection;
...
initialization
  TPresentationProxyFactory.Current.Register('fgFlipView-Effect', TStyledPresentationProxy<TfgxFlipViewEffectPresentation>);
finalization
  TPresentationProxyFactory.Current.Unregister('fgFlipView-Effect',  TStyledPresentationProxy<TfgxFlipViewEffectPresentation>);
end.
